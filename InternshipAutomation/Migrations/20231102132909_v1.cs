        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminUser_InternshipId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWorkingSaturday = table.Column<bool>(type: "bit", nullable: false),
                    ApprovedUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CompanyUser_InternshipId",
                table: "AspNetUsers",
                column: "CompanyUser_InternshipId",
                unique: true,
                filter: "[InternshipId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Internships_CompanyUser_InternshipId",
                table: "AspNetUsers",
                column: "CompanyUser_InternshipId",
                principalTable: "Internships",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Internships_InternshipId",
                table: "AspNetUsers",
                column: "InternshipId",
                principalTable: "Internships",
                principalColumn: "Id");
